...
<div id="deleteCarModal" class="modal" hidden>
    <div class="modal-overlay" data-close-delete-car-modal></div>
    <section class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="deleteCarTitle">
        <div class="modal-header">
            <div>
                <span class="modal-kicker"><spring:message code="cars.delete.kicker"/></span>
                <h2 id="deleteCarTitle"><spring:message code="cars.delete.title"/></h2>
            </div>
            <button type="button" class="modal-close" data-close-delete-car-modal aria-label="${closeModalLabel}">
