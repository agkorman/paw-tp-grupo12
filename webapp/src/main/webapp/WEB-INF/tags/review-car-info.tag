...
<aside class="review-form-panel car-info-panel">
    ...
    <div class="car-info-list">
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.name"/></span>
            <span class="car-info-value"><c:out value="${selectedCar.model}"/></span>
        </div>
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.year"/></span>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.brand"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.type"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.fuelType"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.transmission"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.horsepower"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.airbags"/></span>
            <span class="car-info-value">
                <c:choose>
        ...
        <c:if test="${selectedCar.fuelType ne 'electric'}">
            <div class="car-info-row">
                <span class="car-info-label"><spring:message code="review.carInfo.consumption"/></span>
                <span class="car-info-value">
                    <c:choose>
        ...
        <div class="car-info-row">
            <span class="car-info-label"><spring:message code="review.carInfo.maxSpeed"/></span>
            <span class="car-info-value">
                <c:choose>
