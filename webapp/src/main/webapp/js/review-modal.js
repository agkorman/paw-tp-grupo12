(function () {
    ...
    var emailInput = $('modalReviewerEmail');
    ...
    var createTexts = {
        ...
        subtitle: 'Completá los campos de la reseña. Tu email se guardará para vincular esta reseña a una cuenta más adelante.',
    ...
    function setEditMode(trigger) {
        ...
        if (emailInput) emailInput.value = data.reviewReviewerEmail || '';
